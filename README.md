# Remember Lockpick Angle NG

Remember Lockpick Angle updated for the Next-Gen and Anniversary Editions.<br>
...
## Getting Started
```bat
git clone --recurse-submodules https://github.com/Ungeziefi/Remember-Lockpick-Angle-NG
cd Remember-Lockpick-Angle-NG
```
